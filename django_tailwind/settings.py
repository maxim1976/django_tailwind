...
ALLOWED_HOSTS = ['wuminghualien.com', 'djangotailwind-production-3540.up.railway.app', 'localhost', '127.0.0.1']

CSRF_TRUSTED_ORIGINS = ['https://wuminghualien.com', 'https://djangotailwind-production-3540.up.railway.app']
